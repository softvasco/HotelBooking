...
builder.Services.AddIdentityCore<ApplicationUser>(options => options.SignIn.RequireConfirmedAccount = false) //options.SignIn.RequireConfirmedAccount=true - send an email to confirm..I'll avoid it for now
